  ...
  return (
    <>
      ...
      <CartDrawer
        ...
        street={cart.street}
        setStreet={cart.setStreet}
        streetNumber={cart.streetNumber}
        setStreetNumber={cart.setStreetNumber}
        complement={cart.complement}
        setComplement={cart.setComplement}
        neighborhood={cart.neighborhood}
        setNeighborhood={cart.setNeighborhood}
        addressComplete={cart.addressComplete}
