...
export const PRODUCTS = [
  ...
  // ── Coleção Das Estações ──
  {
    ...
    image2: '/assets/produtos/frio-que-aquece-iceberg.jpg', // versão em cera bicolor (o "iceberg") — clique/arraste no card ou no modal pra ver
  ...
  },
  {
    ...
    tagline: 'Vela luminária de Natal · glitter vermelho',
    ...
    description:
      'Vela luminária: o glitter vermelho brilha por dentro do vidro quando acesa, criando um efeito bem bonito no escuro. Não acompanha laço decorativo — é só a vela.',
    collection: 'Natal',
  },
  {
    id: 'feliz-natal-verde',
    name: 'Feliz Natal — Verde',
    tagline: 'Vela luminária de Natal · glitter verde',
    weight: '240g', // estimado pelo formato do pote — sem grama visível na etiqueta
    price: 80,
    image: '/assets/produtos/feliz-natal-2.jpg',
    notes: ['Especiarias', 'Pinho', 'Baunilha'],
    description:
      'Vela luminária: o glitter verde brilha por dentro do vidro quando acesa, criando um efeito bem bonito no escuro. Não acompanha laço decorativo — é só a vela.',
    collection: 'Natal',
  },
  {
    id: 'feliz-natal-dourada',
    name: 'Feliz Natal — Dourada',
    tagline: 'Vela luminária de Natal · glitter dourado',
    weight: '240g', // estimado pelo formato do pote — sem grama visível na etiqueta
    price: 80,
    image: '/assets/produtos/feliz-natal-3.jpg',
    notes: ['Especiarias', 'Âmbar', 'Baunilha'],
    description:
      'Vela luminária: o glitter dourado brilha por dentro do vidro quando acesa, criando um efeito bem bonito no escuro. Não acompanha laço decorativo — é só a vela.',
    collection: 'Natal',
  },
];

/**
 * Exemplos reais de lembrancinhas personalizadas — usados no carrossel
 * em pilha da seção "Personalizados". Fotos de encomendas de verdade
 * (nomes e datas reais dos clientes já borrados/anonimizados quando
 * necessário pela própria Naara antes de enviar).
 */
export const PERSONALIZADOS_EXEMPLOS = [
  {
    id: 'casamento',
    image: '/assets/produtos/personalizada.jpg',
    caption: 'Lembrança de casamento · rótulo personalizado',
  },
  {
    id: 'bebe',
    image: '/assets/produtos/personalizada-bebe.jpg',
    caption: 'Chá de bebê · rótulo personalizado',
  },
  {
    id: 'padrinhos',
    image: '/assets/produtos/personalizada-padrinhos.jpg',
    caption: 'Padrinho e madrinha · rótulo personalizado',
  },
  {
    id: 'aniversario',
    image: '/assets/produtos/personalizada-aniversario.jpg',
    caption: 'Aniversário de 25 anos · flores e rótulo personalizado',
  },
];
...
export const KITS = [
  ...
  // 'Kit Coelho e Cacau' e 'Coelho Luminescent' removidos — os dois
  // coelhinhos saíram da loja. As imagens continuam em
  // /assets/produtos/kit-coelho-cacau.jpg e coelho-luminescent.jpg, prontas
  // se algum deles voltar a ser vendido.
];
...
export const FAQ = [
  ...
  {
    q: 'E os kits e presentes prontos, como a Vela Lídia ou a Vela Sônia?',
    a: 'Esses fogem do formato de pote simples (têm bandeja e molde decorativo), então o orçamento e o frete deles são combinados direto no WhatsApp, fora do carrinho do site.',
  },
  {
    q: 'Como faço meu pedido?',
    a: 'Monte sua sacola aqui no site e finalize o pagamento direto por aqui, com segurança do Mercado Pago — Pix, cartão ou boleto. Assim que o pagamento é aprovado, o pedido segue para produção.',
  },
  {
    q: 'Qual o prazo de produção?',
    a: 'Cada vela é feita à mão, sob encomenda — a Naara leva até 3 dias úteis para confeccionar e embalar seu pedido antes de despachar. Esse prazo é à parte do prazo de entrega da transportadora, que aparece no frete calculado no carrinho.',
  },
  {
