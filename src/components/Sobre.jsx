...
export default function Sobre() {
  return (
    <section id="sobre" className="relative overflow-hidden py-20 md:py-32">
      ...
      <div className="wrap relative grid items-center gap-12 lg:grid-cols-[minmax(0,380px)_1fr] lg:gap-16">
        <figure className="reveal mx-auto w-full max-w-[320px] lg:mx-0 lg:max-w-none">
          <div className="overflow-hidden rounded-sm shadow-[0_30px_60px_-24px_rgba(74,14,122,.35)]">
            <img
              src="/assets/naara.jpg"
              alt="Naara Carreira, artesã da Luminescent"
              loading="lazy"
