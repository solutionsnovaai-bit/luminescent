export const Wpp = (p) => (
  <svg viewBox="0 0 24 24" aria-hidden="true" {...p}>
    <path fill="currentColor" d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.79 1.22h.01c5.46 0 9.91-4.45 9.91-9.91S17.5 2 12.04 2m0 18.15h-.01a8.2 8.2 0 0 1-4.19-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.2 8.2 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.25-8.24a8.2 8.2 0 0 1 8.24 8.25c0 4.54-3.7 8.23-8.24 8.23m4.52-6.16c-.25-.12-1.47-.72-1.69-.81s-.39-.12-.56.13-.64.81-.79.98-.29.19-.54.06a6.7 6.7 0 0 1-1.99-1.23 7.4 7.4 0 0 1-1.37-1.71c-.14-.25-.01-.38.11-.5s.25-.29.37-.44.17-.25.25-.41.04-.31-.02-.44-.56-1.35-.77-1.85c-.2-.48-.41-.42-.56-.43h-.48a.93.93 0 0 0-.67.31 2.82 2.82 0 0 0-.87 2.09 4.88 4.88 0 0 0 1.02 2.59 11.2 11.2 0 0 0 4.28 3.79c.6.26 1.06.41 1.43.53.6.19 1.14.16 1.57.1.48-.07 1.47-.6 1.68-1.18s.21-1.08.15-1.19-.23-.17-.48-.29" />
  </svg>
);
...
export const Flame = (p) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...p}>
    <path d="M12 3c.6 3.2-1.9 4.2-1.9 6.6 0 1 .6 1.8 1.4 2.2-.3-1.6.5-2.7 1.3-3.4 1.9 1.7 3.2 3.4 3.2 5.7A6 6 0 1 1 6 14c0-4.2 4.4-5.6 6-11Z"
...
export const Lock = (p) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...p}>
    ...
    <path d="M8 10.5V7.8a4 4 0 0 1 8 0v2.7" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);

export const Spinner = (p) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className="animate-spin" {...p}>
...
export const Truck = (p) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...p}>
    ...
    <path d="M13 10h4l3 3v3h-7z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
...
export const Layers = (p) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...p}>
    <path d="M12 3 2.5 8.5 12 14l9.5-5.5L12 3Z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" />
    <path d="M2.5 13 12 18.5 21.5 13" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
export const User = (p) => (
  <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...p}>
    ...
    <path d="M4.5 20c1.2-3.8 4.4-5.8 7.5-5.8s6.3 2 7.5 5.8" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
  </svg>
);
