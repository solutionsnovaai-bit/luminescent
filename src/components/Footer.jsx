    ...
    <footer className="bg-plum-ink pt-16 text-cream/70">
      <div className="wrap grid gap-10 pb-14 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex flex-col gap-3">
          <span className="label mb-1 text-orchid-glow">Loja</span>
          <a href="#velas" className="text-[14px] transition-colors hover:text-cream">Todas as velas</a>
          <a href="#kits" className="text-[14px] transition-colors hover:text-cream">Kits e presentes</a>
